...
class CI_TestCase extends PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->ci_vfs_root = org\bovigo\vfs\vfsStream::setup();
		$this->ci_app_root = org\bovigo\vfs\vfsStream::newDirectory('application')->at($this->ci_vfs_root);
		$this->ci_base_root = org\bovigo\vfs\vfsStream::newDirectory('system')->at($this->ci_vfs_root);
		$this->ci_view_root = org\bovigo\vfs\vfsStream::newDirectory('views')->at($this->ci_app_root);
	...
	public function ci_vfs_mkdir($name, $root = NULL)
	{
		...
		return org\bovigo\vfs\vfsStream::newDirectory($name)->at($root);
	}
	...
	public function ci_vfs_create($file, $content = '', $root = NULL, $path = NULL)
	{
		...
		// Create tree
        org\bovigo\vfs\vfsStream::create($tree, $root);
	}
	...
	public function ci_vfs_path($path, $base = '')
	{
		...
		return org\bovigo\vfs\vfsStream::url(ltrim($path, '/'));
	}
