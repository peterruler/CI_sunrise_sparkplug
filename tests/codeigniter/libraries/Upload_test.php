...
class Upload_test extends CI_TestCase {
	...
	{
		$this->markTestSkipped("We can't test this at the moment because of the call to is_uploaded_file() in do_upload() which isn't supported by org\bovigo\vfs\vfsStream.");
	}
