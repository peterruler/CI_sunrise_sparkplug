...
<label for="startdate">Startdate</label><br/>
	<input type="date" name="startdate" value="<?= $result["startdate"];?>" id="startdate" size="50" style="width:100%" class="form-control" placeholder="2014:05:Sat"  />
	
	<p>
<label for="enddate">Enddate</label><br/>
	<input type="date" name="enddate" value="<?= $result["enddate"];?>" id="enddate" size="50" style="width:100%" class="form-control" placeholder="2014:05:Sat"  />
